void component_comp(string variable = "pt") {
// A program to plot the histograms of a variable for fake and prompt photons
// in the three GJet bins.

cout << "This program compares components on EE using the diphoton presel.";
//cout << "This program compares components usign single photon cuts.";
...
TFile *file2040 = new TFile("/afs/cern.ch/user/f/fabricio/CMSSW_7_6_3_patch2/src/diPhoton/20-40/output_numEvent40000.root");
TTree *fake2040 = (TTree*)file2040->Get("photonViewDumper/trees/fakePhotonsEE");
TTree *prompt2040 = (TTree*)file2040->Get("photonViewDumper/trees/promptPhotonsEE");
...
TFile *file4080 = new TFile("/afs/cern.ch/user/f/fabricio/CMSSW_7_6_3_patch2/src/diPhoton/40-80/output_numEvent40000.root");
TTree *fake4080 = (TTree*)file4080->Get("photonViewDumper/trees/fakePhotonsEE");
TTree *prompt4080 = (TTree*)file4080->Get("photonViewDumper/trees/promptPhotonsEE");
...
TFile *file40Inf = new TFile("/afs/cern.ch/user/f/fabricio/CMSSW_7_6_3_patch2/src/diPhoton/40-Inf/output_numEvent40000.root");
TTree *fake40Inf = (TTree*)file40Inf->Get("photonViewDumper/trees/fakePhotonsEE");
TTree *prompt40Inf = (TTree*)file40Inf->Get("photonViewDumper/trees/promptPhotonsEE");
...
// ############# SCALE ############# //
//
//Double_t norm = henergy_f2040->GetEntries();
...
henergy_f4080->SetTitle("box1;x;y");
...
// ############# SCALE ############# //
//
//norm = henergy_f40Inf->GetEntries();
//henergy_f40Inf->Scale(1/norm);
//
// ############# END SCALE ############# //
...
leg1->AddEntry(henergy_f2040,"pt20-40","l");
leg1->AddEntry(henergy_f40Inf,"pt40-Inf","l");
//leg1->AddEntry(henergy_f4080,"Standard (pt20-40 + pt40-Inf)","l");
//leg1->AddEntry(henergy_f2040,"New (40-80 + pt20-40 + pt40-Inf)","l");
leg1->Draw();
...
henergy_p4080->SetTitle("box1;x;y");
...
// ############# SCALE ############# //
//
//norm = henergy_p40Inf->GetEntries();
//henergy_p40Inf->Scale(1/norm);
//
// ############# END SCALE ############# //

// Draw, set title (?) and update
henergy_p40Inf->SetLineColor(kGreen);
henergy_p40Inf->SetTitle("box1;x;y");
...
leg2->AddEntry(henergy_p4080,"40-80","l");
leg2->AddEntry(henergy_p2040,"pt20-40","l");
leg2->AddEntry(henergy_p40Inf,"pt40-Inf","l");
//leg2->AddEntry(henergy_p4080,"Standard (pt20-40 + pt40-Inf)","l");
//leg2->AddEntry(henergy_p2040,"New (40-80 + pt20-40 + pt40-Inf)","l");
leg2->Draw();
